#NEW
execute unless score blazeandcave:challenges/abyss_lord bac_obtained matches 1.. run scoreboard players operation blazeandcave:challenges/abyss_lord tracker_advancement = @s tracker_players
