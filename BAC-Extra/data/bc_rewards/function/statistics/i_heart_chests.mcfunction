#NEW
execute unless score blazeandcave:statistics/i_heart_chests bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/i_heart_chests tracker_advancement = @s tracker_players
