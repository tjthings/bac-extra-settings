#NEW
execute unless score blazeandcave:statistics/novice_enchanter bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/novice_enchanter tracker_advancement = @s tracker_players
