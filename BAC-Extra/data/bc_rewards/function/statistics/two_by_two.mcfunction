#NEW
execute unless score blazeandcave:statistics/two_by_two bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/two_by_two tracker_advancement = @s tracker_players
