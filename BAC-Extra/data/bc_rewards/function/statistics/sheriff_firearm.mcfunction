#NEW
execute unless score blazeandcave:statistics/sheriff_firearm bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/sheriff_firearm tracker_advancement = @s tracker_players
