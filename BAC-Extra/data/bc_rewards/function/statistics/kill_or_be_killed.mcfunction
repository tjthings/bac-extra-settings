#NEW
execute unless score blazeandcave:statistics/kill_or_be_killed bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/kill_or_be_killed tracker_advancement = @s tracker_players
