#NEW
execute unless score blazeandcave:statistics/happy_new_year bac_obtained matches 1.. run scoreboard players operation blazeandcave:statistics/happy_new_year tracker_advancement = @s tracker_players
