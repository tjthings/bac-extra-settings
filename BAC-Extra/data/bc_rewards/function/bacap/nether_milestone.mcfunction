#NEW
execute unless score blazeandcave:bacap/nether_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/nether_milestone tracker_advancement = @s tracker_players
