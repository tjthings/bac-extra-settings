#NEW
execute unless score blazeandcave:bacap/potion_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/potion_milestone tracker_advancement = @s tracker_players
