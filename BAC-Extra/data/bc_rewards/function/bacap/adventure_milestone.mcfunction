#NEW
execute unless score blazeandcave:bacap/adventure_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/adventure_milestone tracker_advancement = @s tracker_players
