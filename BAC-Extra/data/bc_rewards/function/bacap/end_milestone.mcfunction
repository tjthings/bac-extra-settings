#NEW
execute unless score blazeandcave:bacap/end_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/end_milestone tracker_advancement = @s tracker_players
