#NEW
execute unless score blazeandcave:bacap/monsters_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/monsters_milestone tracker_advancement = @s tracker_players
