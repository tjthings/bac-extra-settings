#NEW
execute unless score blazeandcave:bacap/farming_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/farming_milestone tracker_advancement = @s tracker_players
