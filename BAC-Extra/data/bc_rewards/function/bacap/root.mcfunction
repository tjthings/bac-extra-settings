#NEW
execute unless score blazeandcave:bacap/root bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/root tracker_advancement = @s tracker_players
