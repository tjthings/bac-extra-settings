#NEW
execute unless score blazeandcave:bacap/building_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/building_milestone tracker_advancement = @s tracker_players
