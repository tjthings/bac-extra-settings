#NEW
execute unless score blazeandcave:bacap/mining_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/mining_milestone tracker_advancement = @s tracker_players
