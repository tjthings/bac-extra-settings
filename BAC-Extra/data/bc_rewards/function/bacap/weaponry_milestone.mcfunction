#NEW
execute unless score blazeandcave:bacap/weaponry_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/weaponry_milestone tracker_advancement = @s tracker_players
