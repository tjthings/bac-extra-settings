#NEW
execute unless score blazeandcave:bacap/animal_milestone bac_obtained matches 1.. run scoreboard players operation blazeandcave:bacap/animal_milestone tracker_advancement = @s tracker_players
