#NEW
execute unless score blazeandcave:redstone/travelling_bard bac_obtained matches 1.. run scoreboard players operation blazeandcave:redstone/travelling_bard tracker_advancement = @s tracker_players
