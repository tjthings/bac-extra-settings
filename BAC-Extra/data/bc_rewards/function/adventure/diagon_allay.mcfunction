#NEW
execute unless score blazeandcave:adventure/diagon_allay bac_obtained matches 1.. run scoreboard players operation blazeandcave:adventure/diagon_allay tracker_advancement = @s tracker_players
