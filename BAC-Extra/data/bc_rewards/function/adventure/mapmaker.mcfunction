#NEW
execute unless score blazeandcave:adventure/mapmaker bac_obtained matches 1.. run scoreboard players operation blazeandcave:adventure/mapmaker tracker_advancement = @s tracker_players
