#NEW
execute unless score blazeandcave:adventure/superhero_of_the_village bac_obtained matches 1.. run scoreboard players operation blazeandcave:adventure/superhero_of_the_village tracker_advancement = @s tracker_players
