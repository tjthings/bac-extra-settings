#NEW
execute unless score blazeandcave:adventure/nyan_sheep bac_obtained matches 1.. run scoreboard players operation blazeandcave:adventure/nyan_sheep tracker_advancement = @s tracker_players
