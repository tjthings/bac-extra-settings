#NEW
execute unless score blazeandcave:adventure/disc_jockey bac_obtained matches 1.. run scoreboard players operation blazeandcave:adventure/disc_jockey tracker_advancement = @s tracker_players
