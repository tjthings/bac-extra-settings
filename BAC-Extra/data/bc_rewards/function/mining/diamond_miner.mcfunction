#NEW
execute unless score blazeandcave:mining/diamond_miner bac_obtained matches 1.. run scoreboard players operation blazeandcave:mining/diamond_miner tracker_advancement = @s tracker_players
