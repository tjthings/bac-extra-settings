#NEW
execute unless score blazeandcave:mining/nananananananana bac_obtained matches 1.. run scoreboard players operation blazeandcave:mining/nananananananana tracker_advancement = @s tracker_players
