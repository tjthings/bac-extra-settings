#NEW
execute unless score blazeandcave:mining/iggy bac_obtained matches 1.. run scoreboard players operation blazeandcave:mining/iggy tracker_advancement = @s tracker_players
