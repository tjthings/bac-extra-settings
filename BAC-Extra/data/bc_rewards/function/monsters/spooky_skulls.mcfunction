#NEW
execute unless score blazeandcave:monsters/spooky_skulls bac_obtained matches 1.. run scoreboard players operation blazeandcave:monsters/spooky_skulls tracker_advancement = @s tracker_players
