#NEW
execute unless score blazeandcave:monsters/the_ender_of_ender bac_obtained matches 1.. run scoreboard players operation blazeandcave:monsters/the_ender_of_ender tracker_advancement = @s tracker_players
