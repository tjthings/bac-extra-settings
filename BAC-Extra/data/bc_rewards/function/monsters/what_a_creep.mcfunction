#NEW
execute unless score blazeandcave:monsters/what_a_creep bac_obtained matches 1.. run scoreboard players operation blazeandcave:monsters/what_a_creep tracker_advancement = @s tracker_players
