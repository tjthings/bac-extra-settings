#NEW
execute unless score blazeandcave:animal/someones_been_here_before bac_obtained matches 1.. run scoreboard players operation blazeandcave:animal/someones_been_here_before tracker_advancement = @s tracker_players
