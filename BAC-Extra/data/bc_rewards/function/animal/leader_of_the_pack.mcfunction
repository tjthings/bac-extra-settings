#NEW
execute unless score minecraft:husbandry/tame_an_animal bac_obtained matches 1.. run scoreboard players operation minecraft:husbandry/tame_an_animal tracker_advancement = @s tracker_players
