#NEW
execute unless score blazeandcave:animal/poacher bac_obtained matches 1.. run scoreboard players operation blazeandcave:animal/poacher tracker_advancement = @s tracker_players
