#NEW
execute unless score blazeandcave:animal/lead_the_way bac_obtained matches 1.. run scoreboard players operation blazeandcave:animal/lead_the_way tracker_advancement = @s tracker_players
