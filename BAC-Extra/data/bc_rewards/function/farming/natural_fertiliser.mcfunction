#NEW
execute unless score blazeandcave:farming/natural_fertiliser bac_obtained matches 1.. run scoreboard players operation blazeandcave:farming/natural_fertiliser tracker_advancement = @s tracker_players
