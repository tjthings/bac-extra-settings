#NEW
execute unless score blazeandcave:farming/shrooms bac_obtained matches 1.. run scoreboard players operation blazeandcave:farming/shrooms tracker_advancement = @s tracker_players
