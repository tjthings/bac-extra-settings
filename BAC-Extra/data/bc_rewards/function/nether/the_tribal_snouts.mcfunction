#NEW
execute unless score blazeandcave:nether/the_tribal_snouts bac_obtained matches 1.. run scoreboard players operation blazeandcave:nether/the_tribal_snouts tracker_advancement = @s tracker_players
