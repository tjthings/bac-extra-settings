#NEW
execute unless score blazeandcave:nether/nether_rock_collection bac_obtained matches 1.. run scoreboard players operation blazeandcave:nether/nether_rock_collection tracker_advancement = @s tracker_players
