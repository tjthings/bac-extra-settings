#NEW
execute unless score blazeandcave:nether/electrifying_alliance bac_obtained matches 1.. run scoreboard players operation blazeandcave:nether/electrifying_alliance tracker_advancement = @s tracker_players
