#NEW
execute unless score blazeandcave:nether/inception bac_obtained matches 1.. run scoreboard players operation blazeandcave:nether/inception tracker_advancement = @s tracker_players
