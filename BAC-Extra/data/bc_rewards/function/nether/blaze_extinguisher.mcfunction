#NEW
execute unless score blazeandcave:nether/blaze_extinguisher bac_obtained matches 1.. run scoreboard players operation blazeandcave:nether/blaze_extinguisher tracker_advancement = @s tracker_players
