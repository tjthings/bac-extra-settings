#NEW
execute unless score blazeandcave:biomes/tarzan bac_obtained matches 1.. run scoreboard players operation blazeandcave:biomes/tarzan tracker_advancement = @s tracker_players
