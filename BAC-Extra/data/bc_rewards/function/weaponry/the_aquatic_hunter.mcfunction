#NEW
execute unless score blazeandcave:weaponry/the_aquatic_hunter bac_obtained matches 1.. run scoreboard players operation blazeandcave:weaponry/the_aquatic_hunter tracker_advancement = @s tracker_players
