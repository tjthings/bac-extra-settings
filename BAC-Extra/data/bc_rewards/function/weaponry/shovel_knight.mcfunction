#NEW
execute unless score blazeandcave:weaponry/shovel_knight bac_obtained matches 1.. run scoreboard players operation blazeandcave:weaponry/shovel_knight tracker_advancement = @s tracker_players
