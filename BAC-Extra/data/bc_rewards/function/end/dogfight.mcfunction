#NEW
execute unless score blazeandcave:end/dogfight bac_obtained matches 1.. run scoreboard players operation blazeandcave:end/dogfight tracker_advancement = @s tracker_players
