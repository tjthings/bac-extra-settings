#NEW
execute unless score blazeandcave:building/translucence bac_obtained matches 1.. run scoreboard players operation blazeandcave:building/translucence tracker_advancement = @s tracker_players
