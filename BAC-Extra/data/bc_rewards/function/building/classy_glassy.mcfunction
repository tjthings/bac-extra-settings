#NEW
execute unless score blazeandcave:building/classy_glassy bac_obtained matches 1.. run scoreboard players operation blazeandcave:building/classy_glassy tracker_advancement = @s tracker_players
