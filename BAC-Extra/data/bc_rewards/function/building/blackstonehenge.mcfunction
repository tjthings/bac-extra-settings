#NEW
execute unless score blazeandcave:building/blackstonehenge bac_obtained matches 1.. run scoreboard players operation blazeandcave:building/blackstonehenge tracker_advancement = @s tracker_players
