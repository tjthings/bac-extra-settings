#NEW
execute unless score blazeandcave:building/the_rainbow_you_always_wanted bac_obtained matches 1.. run scoreboard players operation blazeandcave:building/the_rainbow_you_always_wanted tracker_advancement = @s tracker_players
