#NEW
execute unless score blazeandcave:enchanting/machine_bow bac_obtained matches 1.. run scoreboard players operation blazeandcave:enchanting/machine_bow tracker_advancement = @s tracker_players
