#NEW
execute unless score blazeandcave:enchanting/master_miner bac_obtained matches 1.. run scoreboard players operation blazeandcave:enchanting/master_miner tracker_advancement = @s tracker_players
