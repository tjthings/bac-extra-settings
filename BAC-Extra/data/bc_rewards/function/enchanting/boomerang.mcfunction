#NEW
execute unless score blazeandcave:enchanting/boomerang bac_obtained matches 1.. run scoreboard players operation blazeandcave:enchanting/boomerang tracker_advancement = @s tracker_players
